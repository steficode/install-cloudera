...
MariaDB [(none)]> GRANT REPLICATION SLAVE ON *.* TO 'root'@**'%**' IDENTIFIED BY '**********';

```
> Be careful to specify the wildcard instead of the hostname in the command 'GRANT REPLICATION ... FROM THE MASTER NODE'
...
*************************** 1. row ***************************
               Slave_IO_State: Waiting for master to send event
                  Master_Host: stf-btc-20171030-1.gce.cloudera.com
                  Master_User: root
                  Master_Port: 3306
                Connect_Retry: 60
              Master_Log_File: master1-bin.000001
          Read_Master_Log_Pos: 4952
  ...
  Replicate_Wild_Ignore_Table:
                   ...
                   Last_Error:
                 Skip_Counter: 0
          Exec_Master_Log_Pos: 4952
              Relay_Log_Space: 2435
